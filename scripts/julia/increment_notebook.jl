...
begin
	using GLMakie, NCDatasets, PlutoUI
	Makie.inline!(false)
end

# ╔═╡ d0fa1fab-ab21-4f41-8bb3-08d63aa05170
md"# Setup"
...
begin
  archive1="/home/roels/plots/envar/"
  archive2="/home/roels/plots/3dvar/"	
  an_filename="MXMIN1999+0000.nc"
  bg_filename="ICMSHHARM+0003.nc"
  an1 = NCDataset("$archive1/$an_filename")
  an2 = NCDataset("$archive2/$an_filename")
  bg1 = NCDataset("$archive1/$bg_filename")  
  bg2 = NCDataset("$archive2/$bg_filename")
 nothing
 
end 

# ╔═╡ d3ed5053-08de-421e-adf2-b845ac181445
@bind lev PlutoUI.Slider(lpad.(1:65,3,"0"),show_value=true)
...
manifest_format = "2.0"
project_hash = "536f880f71f2dc082e7190bc46284ab95aa0ef88"
...
git-tree-sha1 = "264d8e2491a2e014b262342929f0a2a9a80a45d8"
